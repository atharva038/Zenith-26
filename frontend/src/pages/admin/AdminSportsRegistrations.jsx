...
const isPdfUrl = (url) => {
  ...
  return url.includes('.pdf') || 
         ...
         url.includes('/raw/'); // Cloudinary raw uploads are typically PDFs
};
...
const AdminSportsRegistrations = () => {
  ...
  // View screenshot
  const handleViewScreenshot = (screenshotUrl, type = "Transaction Receipt") => {
  ...
  return (
    <AdminLayout>
      <div className="min-h-screen bg-[#0a0a0a] text-white p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-400 text-sm font-medium">Total Teams</span>
                <div className="w-12 h-12 bg-purple-500/10 rounded-xl flex items-center justify-center">
                  <span className="text-2xl">🏆</span>
                </div>
              </div>
              <p className="text-4xl font-bold text-white mb-1">{stats.totalTeams}</p>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-400 text-sm font-medium">Total Players</span>
                <div className="w-12 h-12 bg-blue-500/10 rounded-xl flex items-center justify-center">
                  <span className="text-2xl">👥</span>
                </div>
              </div>
              <p className="text-4xl font-bold text-white mb-1">{stats.totalPlayers}</p>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-400 text-sm font-medium">Need Accommodation</span>
                <div className="w-12 h-12 bg-green-500/10 rounded-xl flex items-center justify-center">
                  <span className="text-2xl">🏨</span>
                </div>
              </div>
              <p className="text-4xl font-bold text-white mb-1">{stats.needAccommodation}</p>
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <span className="text-gray-400 text-sm font-medium">Pending Review</span>
                <div className="w-12 h-12 bg-yellow-500/10 rounded-xl flex items-center justify-center">
                  <span className="text-2xl">⏳</span>
                </div>
              </div>
              <p className="text-4xl font-bold text-white mb-1">{stats.pendingStatus}</p>
        ...
        {/* Sport-wise Stats */}
        {stats && stats.sportCounts && Object.keys(stats.sportCounts).length > 0 && (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {Object.entries(stats.sportCounts)
                ...
                .map(([sport, count]) => (
                  ...
                  >
                    <p className="text-3xl font-bold text-purple-400 group-hover:scale-110 transition-transform">{count}</p>
                    <p className="text-sm text-gray-400 mt-2 group-hover:text-gray-300">{sport}</p>
                  </div>
                ))}
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-2xl p-6 border border-gray-800 mb-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <select
              ...
              onChange={(e) => handleFilterChange({needAccommodation: e.target.value})}
              className="bg-[#0a0a0a] border border-gray-800 rounded-xl px-4 py-3 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all text-white"
            >
              <option value="" className="bg-[#1a1a1a]">All Accommodation</option>
              <option value="yes" className="bg-[#1a1a1a]">Need Accommodation</option>
              <option value="no" className="bg-[#1a1a1a]">No Accommodation</option>
            </select>
            ...
            {pagination.totalPages > 1 && (
              <div className="flex justify-center items-center gap-4 mt-6">
                ...
                <span className="text-gray-300 px-4 py-3 bg-gradient-to-br from-[#1a1a1a] to-[#252525] rounded-xl border border-gray-800">
                  Page <span className="text-white font-bold">{filters.page}</span> of <span className="text-white font-bold">{pagination.totalPages}</span>
                </span>
                <button
                  onClick={() => handleFilterChange({page: filters.page + 1})}
              ...
              >
                      ...
                      {selectedRegistration.documents.permissionLetter && (
                        ...
                        >
                          <div className="w-full h-32 bg-purple-500/10 rounded-lg flex items-center justify-center mb-3 group-hover:bg-purple-500/20 transition-colors overflow-hidden">
                            {isPdfUrl(selectedRegistration.documents.permissionLetter) ? (
                              <div className="flex flex-col items-center justify-center">
                                <span className="text-4xl">📄</span>
                                <span className="text-purple-400 text-xs mt-1">PDF</span>
                              </div>
                            ) : (
                              <>
                                <img 
                      ...
                      {selectedRegistration.documents.transactionReceipt && (
                        ...
                        >
                          <div className="w-full h-32 bg-blue-500/10 rounded-lg flex items-center justify-center mb-3 group-hover:bg-blue-500/20 transition-colors overflow-hidden">
                            {isPdfUrl(selectedRegistration.documents.transactionReceipt) ? (
                              <div className="flex flex-col items-center justify-center">
                                <span className="text-4xl">🧾</span>
                                <span className="text-blue-400 text-xs mt-1">PDF</span>
                              </div>
                            ) : (
                              <>
                                <img 
                      ...
                      {selectedRegistration.documents.captainIdCard && (
                        ...
                        >
                          <div className="w-full h-32 bg-green-500/10 rounded-lg flex items-center justify-center mb-3 group-hover:bg-green-500/20 transition-colors overflow-hidden">
                            {isPdfUrl(selectedRegistration.documents.captainIdCard) ? (
                              <div className="flex flex-col items-center justify-center">
                                <span className="text-4xl">🪪</span>
                                <span className="text-green-400 text-xs mt-1">PDF</span>
                              </div>
                            ) : (
                              <>
                                <img 
                ...
                <div className="mt-8 flex gap-4">
                  {selectedRegistration.status !== "confirmed" && (
                    <button
                      onClick={() => handleUpdateStatus(selectedRegistration._id, "confirmed")}
                  ...
                  {selectedRegistration.status !== "cancelled" && (
                    <button
                      onClick={() => handleUpdateStatus(selectedRegistration._id, "cancelled")}
                  ...
                  {selectedScreenshot.url?.includes('.pdf') || 
                   ...
                   selectedScreenshot.url?.includes('/raw/') ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-800 font-semibold mb-2">PDF Document</p>
                      <p className="text-gray-600 mb-6">Click the button below to view or download the PDF</p>
                      <a
                        href={selectedScreenshot.url}
                        target="_blank"
                        rel="noopener noreferrer"
