...
const MediaTeamDashboard = () => {
  ...
  useEffect(() => {
    const token = localStorage.getItem("mediaTeamToken");
    if (!token) {
      navigate("/media-team/login");
    }
  }, [navigate]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-black text-white">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 shadow-lg shadow-green-500/20">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold font-rajdhani">ZENITH 2026</h1>
            <p className="text-green-100 text-sm">Media Team Portal</p>
          </div>
          <button
            onClick={handleLogout}
            className="px-6 py-2 bg-white/10 hover:bg-white/20 rounded-lg font-semibold transition-all backdrop-blur-sm"
          >
            Logout
          </button>
        </div>
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="mb-6">
          <h2 className="text-3xl font-bold text-green-400 font-rajdhani">
            Gallery Management
          </h2>
        </div>
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-xl rounded-xl p-6 border border-green-500/20 max-w-2xl"
          >
            <h2 className="text-2xl font-bold mb-6 text-green-400 font-rajdhani">
              Upload Media
            </h2>
            ...
            <form onSubmit={handleUpload} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-gray-800/50 border border-gray-700 rounded-lg text-white text-sm focus:outline-none focus:border-green-500 transition-colors"
                />
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-green-500 to-emerald-600 text-white py-2.5 px-6 rounded-lg font-bold text-sm hover:shadow-lg hover:shadow-green-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            >
              {media.map((item, index) => (
                <motion.div
                  ...
                  className="group relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl overflow-hidden border border-gray-700 hover:border-green-500/50 transition-all"
                >
                  {/* Media Preview */}
