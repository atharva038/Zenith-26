...
const sportsData = [
  ...
  },
  {
    ...
    tagline: "Smash & Win",
    description:
      "Fast-paced rallies and powerful smashes await! Choose from Boys, Solo Women, or Mixed team categories.",
    date: "February 20-21, 2026",
    venue: "Indoor Sports Complex",
    teamSize: "Boys Team: 5 players | Solo Women: 1 player | Mixed Team: 2 players (1 Boy + 1 Girl)",
    registrationFee: "Boys: ₹1000 | Solo Women: ₹250 | Mixed: ₹600",
    rules: [
