                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-black/40 border border-[#ff8b1f]/30 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-[#ff8b1f] focus:border-transparent transition-all"
                    >
                      <option value="5K" className="bg-[#1a0f08]">
                        5K Run
                      </option>
                      <option value="10K" className="bg-[#1a0f08]">
                        10K Run
                      </option>
                      <option value="Half Marathon" className="bg-[#1a0f08]">
                        Half Marathon (21K)
                      </option>
                    </select>
                  </div>
                ...
                <div className="bg-gradient-to-br from-[#ff8b1f]/10 to-[#ffb36a]/10 border-2 border-[#ff8b1f]/30 rounded-xl p-6">
                  ...
                  <div className="mt-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3">
                    <p className="text-yellow-300 text-xs">
                      ...
                      confirmed only after payment verification. Please keep
                      your transaction ID safe for reference.
                    </p>
                  </div>
                </div>
              </div>
