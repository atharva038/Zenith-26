          ...
          >
            ...
            {member.phoneNumber && (
              <a 
                ...
                className="mt-2 inline-flex items-center gap-1.5 text-xs text-white/60 hover:text-white transition-colors duration-300"
              >
        ...
        >
          ...
          <div className="mt-4 text-center opacity-70 group-hover:opacity-100 transition-opacity duration-300">
            ...
            {member.phoneNumber && (
              <a 
                href={`tel:${member.phoneNumber}`}
                className="mt-1.5 inline-flex items-center gap-1 text-xs text-white/50 hover:text-white transition-colors duration-300"
              >
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            ...
            <motion.p
              ...
              className="text-orange-400 text-sm uppercase tracking-[0.3em] mb-6"
            >
              The Leadership
            </motion.p>
            ...
            >
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-500 via-red-500 to-orange-500 rounded-2xl opacity-50 group-hover:opacity-75 blur-sm transition-opacity duration-500" />
              
              {/* Photo container */}
              <div className="relative w-64 h-72 md:w-72 md:h-80 rounded-xl overflow-hidden border-2 border-orange-500/30">
                <img
                  src="/img/sportsSecretory.png"
                  alt="Sagar Ubale - Sports Secretary"
            ...
            >
              ...
              <p className="text-xl md:text-2xl bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent font-semibold">
                Sports Secretary
              </p>
              <a 
                href="tel:9545956689"
                className="inline-flex items-center gap-2 text-gray-400 mt-3 text-sm tracking-wide hover:text-orange-400 transition-colors"
              >
                <span>📞</span> 9545956689
              </a>
            ...
            <motion.div
              ...
              className="mt-8 h-px w-32 bg-gradient-to-r from-transparent via-orange-500/50 to-transparent"
            />
          </motion.div>
        </div>
      </section>
